...
This visual implements the **Duval Triangle Method** for transformer fault classification. It maps five DGA gas vectors to determine the fault type based on the center of mass within an irregular polygon.
