...
class LegendTextCard extends FormattingSettingsCard {
    ...
    DT_text = new formattingSettings.TextInput({ name: "DT_text", displayName: "DT Label", value: "DT - Discharge of Thermal Fault", placeholder: "e.g., DT - Discharge of Thermal Fault" });
    ...
    ND_text = new formattingSettings.TextInput({ name: "ND_text", displayName: "ND Label", value: "ND - Not Determined", placeholder: "e.g., ND - Not Determined" });

    name: string = "legendText";
    displayName: string = "Legend";
    slices: Array<FormattingSettingsSlice> = [this.show, this.PD_text, this.T1_text, this.T2_text, this.T3_text, this.DT_text, this.D1_text, this.D2_text, this.S_text, this.O_text, this.C_text, this.ND_text];
}
...
class SegmentsCard extends FormattingSettingsCard {
    ...
    DT = new formattingSettings.ColorPicker({ name: "DT", displayName: "DT Color", value: { value: FAULT_COLORS.DT } });
    ...
    ND = new formattingSettings.ColorPicker({ name: "ND", displayName: "ND Color", value: { value: FAULT_COLORS.ND } });

    name: string = "regionColors";
    displayName: string = "Segments";
    slices: Array<FormattingSettingsSlice> = [this.transparency, this.PD, this.T1, this.T2, this.T3, this.DT, this.D1, this.D2, this.S, this.O, this.C, this.ND];
}
