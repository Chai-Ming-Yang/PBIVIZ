import { Triangle5Specifications } from "../utils/faultSpecifications";
...
describe("Duval Triangle 5 Specifications", () => {
    const specs = Triangle5Specifications.getSpecifications();
    ...
    T5_BOUNDARY_SCENARIOS.flat().forEach(({ id, gas, expected }) => {
